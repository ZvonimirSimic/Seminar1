...
namespace BNG {
    ...
    public class Button : MonoBehaviour {
        ...
        public Mesh combiner(GameObject gam)
        {
            MeshFilter[] filters = gam.GetComponentsInChildren<MeshFilter>();
            Debug.Log("Broj mesheva djece : " + filters.Length);
        ...
        public virtual void OnButtonDown() {
            ...
            if (onButtonDown != null) {
                if (pressed == false)
                {
                    ...
                    Vector3 scal = new Vector3(100F, 100F, 100F);
                    ...
                    if (gamObj.GetComponent<MeshCollider>() == null)
                    {
                        gamObj.AddComponent<MeshCollider>();
                    }
                    if (gamObj.GetComponent<MeshRenderer>() == null)
                    {
                        gamObj.AddComponent<MeshRenderer>();
                    }
                    if (gamObj.GetComponent<MeshFilter>() == null)
                    {
                        gamObj.AddComponent<MeshFilter>();
                    }
                    gamObj.GetComponent<MeshCollider>().sharedMesh = new Mesh();
                    gamObj.GetComponent<MeshCollider>().sharedMesh = combiner(gamObj);
                    gamObj.GetComponent<MeshFilter>().sharedMesh = new Mesh();
                    gamObj.GetComponent<MeshFilter>().sharedMesh = combiner(gamObj);
                    Debug.Log("Mesh je " + gamObj.GetComponent<MeshCollider>().sharedMesh.name);
                    gamObj.GetComponent<MeshCollider>().convex = true;
